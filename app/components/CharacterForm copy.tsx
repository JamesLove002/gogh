...
type Props = {
  formId: string;
  characterFormData: ICharacter;
  forNewCharacter?: boolean;
};

const CharacterForm = ({ formId, characterFormData, forNewCharacter: forNewPet = true }: Props) => {
  ...
  const [form, setForm] = useState({
    ...
    owner_name: characterFormData.owner_name,
    species: characterFormData.species,
    age: characterFormData.age,
    poddy_trained: characterFormData.poddy_trained,
    diet: characterFormData.diet,
    image_url: characterFormData.image_url,
    likes: characterFormData.likes,
    dislikes: characterFormData.dislikes
  });

  /* The PUT method edits an existing entry in the mongodb database. */
  const putData = async (form: CharacterFormData) => {
  ...
  const postData = async (form: CharacterFormData) => {
    try {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const value = target.name === "poddy_trained" ? (target as HTMLInputElement).checked : target.value;
