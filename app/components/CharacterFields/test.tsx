...
import { flawOptions } from "@/services/generator/generators/flawGenerator";
...
function renderRow(props: ListChildComponentProps) {
  ...
  return (
    <Typography component="li" {...dataSet[0]} noWrap style={inlineStyle}>
      {`#${dataSet[2] + 1} - ${dataSet[1].instance}`}
    </Typography>
  );
}
...
export default function Virtualize() {
  return (
    <Autocomplete
      ...
      options={flawOptions}
      groupBy={(fuck) => fuck.category.toUpperCase()}
